...
|-------------|-----------------|---------|-----|---------------|------------|-----------|--------|
| Hilfritz Camallere | `hilfritz` | 32 | 15 | 43 | 2710 | 196 | Active contributor |
| Ananya Mandal | `AnanyaMandal-DataAnalyst` | 0 | 4 | 0 | 0 | 0 | Active contributor |
| Daniyal Khan | `daniyalnkh` | 0 | 2 | 0 | 0 | 0 | Active contributor |
| Joseph Jamoralin | `Joseph-dataanalyst` | 0 | 2 | 0 | 0 | 0 | Active contributor |
