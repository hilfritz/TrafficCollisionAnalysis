...
|-------------|-----------------|---------|-----|---------------|------------|-----------|--------|
| Hilfritz Camallere | `hilfritz` | 17 | 3 | 33 | 2376 | 103 | Active contributor |
...
- `chore/US-01-repo-setup`
- `docs/US-01-readme-update`
- `feature/US-04-data-loader`
- `feature/US-05-data-cleaning`
- `main`
- `refactorbranch`
